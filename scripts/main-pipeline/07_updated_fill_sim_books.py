"""
This updated script (compared to #04) uses our new SimBooksPuller class, which
is largely the same as the Envy class from #04, but it's a child class of the
SimItemesPuller class; script #08, which will pull in similar authors for pound
will nearly an exact copy of this script.

Going forward, use this script over #04 to pull sim_books.
"""
...
from guide2kulchur.engineer.simpullers import SimBooksPuller
        ...
        with conn.cursor() as cur:
            async with aiohttp.ClientSession(timeout=timeout,
                ...
                for batch_id in range(NUM_ITER):
                    ...
                    olesha = SimBooksPuller(batch_id=batch_id, 
                                            cursor=cur,
                    ...
                    try:
                        await olesha.load_the_batch(session=sesh,
